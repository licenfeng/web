...
<!--                <el-badge :value="numberFloor" class="item">   </el-badge>-->
                ...
                <el-button type="danger" @click="getRenewNumber">Renew</el-button>
        ...
        <el-form ref="form" :model="form" label-width="200px" class="searchQuery">
            ...
            <el-form-item label="Status">
                <el-select v-model="form.valueType" placeholder="请选择状态">
                    <el-option
      ...
      async  created() {
        ...
        methods: {
            ...
            async getBreNumber() {
                ...
                this.getDataOpen(data);

            },

            async getRenewNumber(){
                const {data}= await this.$axios.getRenewNumber(this.form.breSlipNumber);
                this.getDataOpen(data);
            },


            async  getDataOpen(data){
       ...
       //REnew一份数据
       copyInfo(){
         const res = this.$axios.copyNewBreTreatyBasisNonPropAllListByBreSlipNumber(this.form)
         console.log(res);
       }
  }
}
