    ...
    <el-form :model="form" label-width="auto" :inline="true" ref="ruleForm">
          ...
          <el-col :span="8">
            <el-form-item label="Reinsurer" prop="reinsurer" required>
              <!-- <el-input v-model="form.reinsurer" ></el-input> -->
              <!-- <el-select v-model="form.reinsurer" filterable placeholder="">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="Placement Broker" >
              <!-- <el-input v-model="form.placementBroker" ></el-input> -->
              <!-- <el-select v-model="form.placementBroker" filterable placeholder="">
                <el-option
                        v-for="item in options"
                        :key="item.keyType"
                        :label="item.valueType"
          ...
          <el-col :span="8">
            <el-form-item label="States">
              <!-- <el-input v-model="form.statusReinsurer" ></el-input> -->
...
export default {
  ...
  async created(){
      ...
      // this.getBreWordbookType("Reinsurer");
      // this.getBreWordbookType("PlacementBroker");
      // this.getBreWordbookType("StatusReinsurer");
    },
    methods: {
       selectIndex(){
    ...
    onSubmit() {
      this.$refs['ruleForm'].validate(async (valid) => {
          if (valid) {
            const {data} = await this.$axios.addBreTreatyArrangeAllInfo(this.form)
            if(data.code == 0 ){
